...
#define MIDDLE1_CHANCE 0
#define MIDDLE2_CHANCE 0
#define POST_CHANCE 100
#define GENERATED_CHANCE 50

@implementation MVNameGenerator
- (id)init {
    self = [super init];
    if (self) {
...
- (NSString *)getName {
    return [self getName:YES male:YES prefix:NO postfix:YES];
}
